...
class _AddPageState extends State<AddPage> {
  ...
  Future<void> _postProduct() async {
    // --- DEBUGGING --- 
    final supabaseForDebug = Supabase.instance.client;
    final userForDebug = supabaseForDebug.auth.currentUser;
    print('--- DEBUGGING INFO ---');
    print('Current Supabase User ID: ${userForDebug?.id}');
    print('Current Supabase User Email: ${userForDebug?.email}');
    print('----------------------');
    // --- END DEBUGGING ---
    ...
    try {
      ...
      if (user == null) {
        throw const AuthException('User not authenticated. Please log out and log in again.');
      }
